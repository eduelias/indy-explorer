<template>
    <div :id="item.rootHash">
        ...
        <cred-def-transaction
            ...
            v-on:openDialog="openDialog"
        ></cred-def-transaction>
        <node v-else-if="type == 'NODE'" :item="item" :type="type" v-on:openDialog="openDialog"></node>
        <attrib v-else-if="type == 'ATTRIB'" :item="item" :type="type" v-on:openDialog="openDialog"></attrib>
